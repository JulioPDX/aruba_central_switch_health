...
central_info = {"base_url": "aruba_api_url", "token": {"access_token": "some_token"}}
...
apiMethod = "GET"
apiParams = {"limit": 30, "offset": 0, "sku_type": "MAS"}

# Creating empty list, we will add to this list in a sec
switches = []

# Actual API call here
device_resp = central.command(apiMethod=apiMethod, apiPath=apiPath, apiParams=apiParams)
